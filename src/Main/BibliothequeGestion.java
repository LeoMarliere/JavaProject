...
public class BibliothequeGestion {
	...
	public static List<Book> createBookList() {
		...
		final Book livre11 = new Book("11", "AAK", "Livre11", "Auteur11", 4);
		final Book livre12 = new Book("12", "AAL", "Livre12", "Auteur12", 4);
		final Book livre13 = new Book("13", "AAM", "Livre13", "Auteur13", 3);
		final Book livre14 = new Book("14", "AAN", "Livre14", "Auteur14", 2);
		final Book livre15 = new Book("15", "AAO", "Livre15", "Auteur15", 3);
