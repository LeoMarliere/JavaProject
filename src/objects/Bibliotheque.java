...
public class Bibliotheque {
	...
	// ----------------- Méthode de création d'un objet Bibliotheque ------------------
	
	
	/**
	 * Constructeur du singleton Bibliothèque
	 * En privé pour qu'elle ne puisse pas etre appellé a l'exterieur de la classe
	 */
	private Bibliotheque( ) {
		this.books = new HashMap<Integer, Book>();
		createBookAndHadToList(books);
	}
	
	/**
	 * Méthode servant a créer une unique INSTANCE de la classe Bibliotheque
	 * @return
	 */
	...
	/**
	 * Cette méthode créer 10 listes d'auteurs (un auteur par liste)
	 * Elle crée ensuite 10 livres avec pour une liste d'auteur differents pour chaques
	 * Elle fini par ajouter ses livres au HashMap passer en parametre
	 * @param books
	 */
	public static void createBookAndHadToList(HashMap<Integer, Book> books) {
	...
	// ----------------- Méthode pour gerer la bibliotheque ------------------
